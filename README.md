...
*   **前置声明页**：自动生成符合学校规范的任务书、学术诚信书、使用授权书及 **AI 工具使用说明页**。支持 1.5pt 加粗边框、标题垂直居中及像素级对齐排版，确保与 Word 模板一致。
...
2. 任务书、学术诚信书、使用授权书、**AI 工具使用说明页**的标题默认采用 **方正小标宋简体二号** 字。模板会首先检测放在项目根目录的项目内字体文件（`FZXBSJW.ttf`），若不存在则使用黑体回退。
